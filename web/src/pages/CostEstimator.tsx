...
export default function CostEstimator() {
  ...
  // Pure client-side calculation against public list pricing -- there is no
  // cloud billing API to call for an on-prem/private KubeVirt cluster, so
  // this has always been (and stays) an estimate, not sourced billing data.
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Compare cloud storage costs for your VM infrastructure — a calculator against public list pricing, not real billing data"
      />
