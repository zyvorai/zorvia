...
pub fn render(f: &mut Frame, _config: &TuiConfig) {
    ...
    let header_text = Line::from(vec![
        ...
        Span::styled("  │  ".to_string(), Style::default().fg(colors::TEXT_MUTED)),
        Span::styled("📖 Help".to_string(), Style::default().fg(colors::LIGHT_ORANGE).add_modifier(Modifier::BOLD)),
        Span::styled(": Keyboard Shortcuts & Reference".to_string(), Style::default().fg(colors::TEXT)),
    ]);
    ...
    let footer_text = Line::from(vec![
        ...
        Span::styled("Press any key to return".to_string(), Style::default().fg(colors::TEXT)),
        Span::styled(" │ ".to_string(), Style::default().fg(colors::TEXT_MUTED)),
        Span::styled("💡 Tip: ".to_string(), Style::default().fg(colors::WARNING).add_modifier(Modifier::BOLD)),
        Span::styled("Use ".to_string(), Style::default().fg(colors::TEXT_MUTED)),
        Span::styled("Ctrl+P".to_string(), Style::default().fg(colors::LIGHT_ORANGE).add_modifier(Modifier::BOLD)),
        Span::styled(" for quick jump menu".to_string(), Style::default().fg(colors::TEXT_MUTED)),
    ]);
...
fn render_help_content(f: &mut Frame, area: ratatui::layout::Rect) {
    let help_text = vec![
        Line::from(""),
        Line::from(vec![
            Span::styled("⌨  GLOBAL KEYBINDINGS", Style::default().fg(colors::WARNING).add_modifier(Modifier::BOLD | Modifier::UNDERLINED)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("  q / Esc       ", Style::default().fg(colors::ORANGE).add_modifier(Modifier::BOLD)),
        ...
        Line::from(vec![
            Span::styled("  r / Ctrl+R    ", Style::default().fg(colors::ORANGE).add_modifier(Modifier::BOLD)),
            Span::styled("🔄  ", Style::default().fg(colors::TEXT)),
            Span::raw("Refresh data from Kubernetes"),
        ]),
        Line::from(vec![
            Span::styled("  Ctrl+P        ", Style::default().fg(colors::ORANGE).add_modifier(Modifier::BOLD)),
            Span::styled("🚀  ", Style::default().fg(colors::TEXT)),
            Span::raw("Quick jump menu (fuzzy search)"),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("🧭  VIEW NAVIGATION", Style::default().fg(colors::WARNING).add_modifier(Modifier::BOLD | Modifier::UNDERLINED)),
        ]),
        Line::from(""),
        Line::from(vec![
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled("💻  VM LIST VIEW", Style::default().fg(colors::WARNING).add_modifier(Modifier::BOLD | Modifier::UNDERLINED)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("  ↑↓ / j/k      ", Style::default().fg(colors::ORANGE).add_modifier(Modifier::BOLD)),
            Span::raw("Navigate VM list"),
        ]),
        Line::from(vec![
            Span::styled("  Enter         ", Style::default().fg(colors::ORANGE).add_modifier(Modifier::BOLD)),
            Span::raw("View VM details"),
        ]),
        Line::from(vec![
            Span::styled("  s             ", Style::default().fg(colors::SUCCESS).add_modifier(Modifier::BOLD)),
            Span::styled("🟢  ", Style::default().fg(colors::TEXT)),
            Span::raw("Start selected VM"),
        ]),
        Line::from(vec![
            Span::styled("  x             ", Style::default().fg(colors::ERROR).add_modifier(Modifier::BOLD)),
            Span::styled("⏸   ", Style::default().fg(colors::TEXT)),
            Span::raw("Stop selected VM"),
        ]),
        Line::from(vec![
            Span::styled("  d             ", Style::default().fg(colors::ERROR).add_modifier(Modifier::BOLD)),
            Span::styled("🗑️  ", Style::default().fg(colors::TEXT)),
            Span::raw("Delete selected VM (with confirmation)"),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("📸  SNAPSHOTS VIEW", Style::default().fg(colors::WARNING).add_modifier(Modifier::BOLD | Modifier::UNDERLINED)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("  ↑↓ / j/k      ", Style::default().fg(colors::ORANGE).add_modifier(Modifier::BOLD)),
        ...
        Line::from(vec![
            Span::styled("  c             ", Style::default().fg(colors::SUCCESS).add_modifier(Modifier::BOLD)),
            Span::styled("📸  ", Style::default().fg(colors::TEXT)),
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled("⚙️  PROFILES & BLUEPRINTS", Style::default().fg(colors::WARNING).add_modifier(Modifier::BOLD | Modifier::UNDERLINED)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("  ↑↓ / j/k      ", Style::default().fg(colors::ORANGE).add_modifier(Modifier::BOLD)),
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled("💡 STATUS INDICATORS", Style::default().fg(colors::WARNING).add_modifier(Modifier::BOLD | Modifier::UNDERLINED)),
        ]),
        Line::from(""),
        Line::from(vec![
    ...
    let help = Paragraph::new(help_text)
        .block(Block::default().borders(Borders::ALL).border_style(Style::default().fg(colors::BORDER)).title("Keybindings"))
