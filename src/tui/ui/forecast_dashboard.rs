...
pub fn render(f: &mut Frame, area: Rect) {
    ...
    header_spans.push(Span::styled("Resource Forecast", Style::default().fg(Color::Rgb(255, 145, 115)).add_modifier(Modifier::BOLD)));
    ...
    let predictions = vec![
        ...
        Line::from(""),
        Line::from(Span::styled("  CPU (40 cores)", Style::default().fg(Color::White).add_modifier(Modifier::BOLD))),
        Line::from(vec![
        ...
        Line::from(vec![
            ...
            Span::styled(" (+37%) CAPACITY WARNING", Style::default().fg(Color::Rgb(220, 50, 47))),
        ]),
        Line::from(""),
        Line::from(Span::styled("  Memory (160 GiB)", Style::default().fg(Color::White).add_modifier(Modifier::BOLD))),
        Line::from(vec![
            Span::styled("    7 days:  ", Style::default().fg(Color::Gray)),
        ...
        Line::from(""),
        Line::from(Span::styled("  Storage (2 TiB)", Style::default().fg(Color::White).add_modifier(Modifier::BOLD))),
        Line::from(vec![
            Span::styled("    7 days:  ", Style::default().fg(Color::Gray)),
        ...
        Line::from(vec![
            ...
            Span::styled(" (+17%) CRITICAL", Style::default().fg(Color::Rgb(220, 50, 47)).add_modifier(Modifier::BOLD)),
        ]),
    ];
    ...
    let recommendations = vec![
        ...
        Line::from(vec![
            ...
            Span::styled("Expand storage within 30 days", Style::default().fg(Color::White)),
        ]),
        Line::from(vec![
            Span::styled("     Add 500 GiB to prevent capacity exhaustion", Style::default().fg(Color::Gray)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("  2. ", Style::default().fg(Color::Rgb(255, 200, 0))),
            Span::styled("Plan CPU capacity increase in 60 days", Style::default().fg(Color::White)),
        ]),
        Line::from(vec![
            Span::styled("     Add 1 worker node (16 cores)", Style::default().fg(Color::Gray)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("  3. ", Style::default().fg(Color::Rgb(100, 150, 255))),
            Span::styled("Review idle VM resources", Style::default().fg(Color::White)),
        ]),
        Line::from(vec![
            Span::styled("     3 VMs using <5% CPU could be right-sized", Style::default().fg(Color::Gray)),
        ]),
        Line::from(""),
        Line::from(Span::styled(
            "  Confidence",
