...
impl NotificationManager {
    ...
    pub fn success(&mut self, msg: &str) {
        self.notify(Notification::new(msg, NotificationType::Success));
    }
    pub fn info(&mut self, msg: &str) {
        self.notify(Notification::new(msg, NotificationType::Info));
    }
    pub fn warning(&mut self, msg: &str) {
        self.notify(Notification::new(msg, NotificationType::Warning));
    }
    pub fn error(&mut self, msg: &str) {
        self.notify(Notification::new(msg, NotificationType::Error));
    }

    pub fn unread(&self) -> Vec<&Notification> {
        self.notifications
            .iter()
            .filter(|n| !n.read && !n.is_expired())
            .collect()
    }
